...
const authenticationTokenMissingException_1 = __importDefault(require("../excpetions/authenticationTokenMissingException"));
const wrongAuthenticationTokenException_1 = __importDefault(require("../excpetions/wrongAuthenticationTokenException"));
...
async function confirmVendorMiddleware(request, response, next) {
...
exports.default = confirmVendorMiddleware;
